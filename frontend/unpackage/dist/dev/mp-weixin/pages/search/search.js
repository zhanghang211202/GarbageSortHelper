...

{
  ...
  onLoad: function onLoad(option) {
    ...
    recorderManager.onStop(function (res) {
      ...
      uni.uploadFile({
        url: me.serverUrl + '/upload/record/' + me.globalData.userId,
    ...
    takePhoto: function takePhoto() {
      ...
      uni.chooseImage({
        ...
        success: function success(res) {
          ...
          uni.uploadFile({
            url: me.serverUrl + '/upload/image/' + me.globalData.userId,
